...
if (sizeof($params['tags']) > 0) {

    $instagram = getInstagram($params['username'], $params['password']);

    $arMedias = getMedias($params, $instagram);
...
//    $arMedias = array_slice($arMedias, 0, $params['postsCount']);
    ...
    var_dump($response = Request::get("https://instagram.com/accounts/logout/"));
}
